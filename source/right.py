...
keyboard.keymap = [
    [
        ...
        KC.U, KC.I, KC.O, KC.P, KC.BSPC,
        KC.H, KC.J, KC.K, KC.L, KC.ENTER,
        KC.B, KC.N, KC.M, KC.UP, KC.NO,
        KC.NO, KC.NO, KC.LEFT, KC.DOWN, KC.RIGHT,
    ],
    [
        KC.NO, KC.NO, KC.NO, KC.MINS, KC.EQL,
        KC.BSLS, KC.NO, KC.NO, KC.LBRC, KC.RBRC,
        KC.NO, KC.NO, KC.NO, KC.SCLN, KC.QUOT,
        KC.SHIFT, KC.NO, KC.COMM, KC.DOT, KC.SLSH,
